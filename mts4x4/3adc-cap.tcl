...
proc create_hier_cell_hier_dac_cap { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk m_axis_clk
  create_bd_pin -dir I -type rst s_axi_aresetn
  ...
  connect_bd_net -net aclk_1 [get_bd_pins m_axis_clk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk]
  connect_bd_net -net axis_clk_1 [get_bd_pins s_axi_clk] [get_bd_pins ADCRAMcapture_0/axis_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk]
...
proc create_hier_cell_hier_adc2_cap { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Net1 [get_bd_pins s_axi_clk] [get_bd_pins ADCRAMcapture_0/axis_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk]
  connect_bd_net -net clk_wiz_adc1_clk_out1 [get_bd_pins m_axis_clk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk]
...
proc create_hier_cell_gpio_control { parentCell nameHier } {
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_bram_adc/s_axi_aresetn] [get_bd_pins axi_gpio_dac/s_axi_aresetn] [get_bd_pins axi_gpio_fifoflush/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set PL_CLK_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 PL_CLK_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {122880000} \
   ] $PL_CLK_0

  set SYSREF_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 SYSREF_0 ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC0_Refclk_Freq {122.880} \
   ...
   CONFIG.ADC1_Refclk_Freq {122.880} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PL_CLK_0_1 [get_bd_intf_ports PL_CLK_0] [get_bd_intf_pins clocktreeMTS/PL_CLK]
  connect_bd_intf_net -intf_net RAM_interconnect_M01_AXI [get_bd_intf_pins RAM_interconnect/M01_AXI] [get_bd_intf_pins hier_dac_cap/S_AXI]
  connect_bd_intf_net -intf_net RAM_interconnect_M02_AXI [get_bd_intf_pins RAM_interconnect/M02_AXI] [get_bd_intf_pins gpio_control/S_AXI2]
  connect_bd_intf_net -intf_net RAM_interconnect_M03_AXI [get_bd_intf_pins RAM_interconnect/M03_AXI] [get_bd_intf_pins gpio_control/S_AXI3]
  connect_bd_intf_net -intf_net RAM_interconnect_M04_AXI [get_bd_intf_pins RAM_interconnect/M04_AXI] [get_bd_intf_pins gpio_control/S_AXI1]
  connect_bd_intf_net -intf_net RAM_interconnect_M05_AXI [get_bd_intf_pins RAM_interconnect/M05_AXI] [get_bd_intf_pins hier_adc0_cap/S_AXI]
  connect_bd_intf_net -intf_net RAM_interconnect_M06_AXI [get_bd_intf_pins RAM_interconnect/M06_AXI] [get_bd_intf_pins hier_adc1_cap/S_AXI]
  connect_bd_intf_net -intf_net RAM_interconnect_M07_AXI [get_bd_intf_pins RAM_interconnect/M07_AXI] [get_bd_intf_pins hier_adc2_cap/S_AXI]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins RAM_interconnect/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net SYSREF_0_1 [get_bd_intf_ports SYSREF_0] [get_bd_intf_pins clocktreeMTS/SYSREF]
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins axis_broadcaster_0/M04_AXIS] [get_bd_intf_pins hier_dac_cap/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins RAM_interconnect/M00_AXI] [get_bd_intf_pins hier_dac_play/S_AXI]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M02_AXIS [get_bd_intf_pins axis_broadcaster_0/M02_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/s10_axis]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M03_AXIS [get_bd_intf_pins axis_broadcaster_0/M03_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/s11_axis]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins control_interconnect/M00_AXI] [get_bd_intf_pins usp_rf_data_converter_0/s_axi]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins clocktreeMTS/s_axi_lite] [get_bd_intf_pins control_interconnect/M01_AXI]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins hier_adc0_cap/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m02_axis [get_bd_intf_pins hier_adc1_cap/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m02_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m12_axis [get_bd_intf_pins hier_adc2_cap/S_AXIS] [get_bd_intf_pins usp_rf_data_converter_0/m12_axis]
  ...
  # Create port connections
  connect_bd_net -net clocktreeMTS_UserSYSREF [get_bd_pins clocktreeMTS/UserSYSREF] [get_bd_pins usp_rf_data_converter_0/user_sysref_adc] [get_bd_pins usp_rf_data_converter_0/user_sysref_dac]
  connect_bd_net -net clocktreeMTS_clkRF [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins clocktreeMTS/clkRF] [get_bd_pins hier_adc0_cap/m_axis_clk] [get_bd_pins hier_adc1_cap/m_axis_clk] [get_bd_pins hier_adc2_cap/m_axis_clk] [get_bd_pins hier_dac_cap/m_axis_clk] [get_bd_pins hier_dac_play/aclk] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk]
  connect_bd_net -net clocktreeMTS_ingress_aresetn [get_bd_pins clocktreeMTS/ingress_aresetn] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/m1_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s1_axis_aresetn]
  connect_bd_net -net clocktreeMTS_interrupt [get_bd_pins clocktreeMTS/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net clocktreeMTS_s_axi_aresetn [get_bd_pins RAM_interconnect/M02_ARESETN] [get_bd_pins RAM_interconnect/M03_ARESETN] [get_bd_pins RAM_interconnect/M04_ARESETN] [get_bd_pins clocktreeMTS/s_axi_aresetn] [get_bd_pins control_interconnect/ARESETN] [get_bd_pins control_interconnect/M00_ARESETN] [get_bd_pins control_interconnect/M01_ARESETN] [get_bd_pins control_interconnect/S00_ARESETN] [get_bd_pins gpio_control/s_axi_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  connect_bd_net -net enable_1 [get_bd_pins gpio_control/dac_enable] [get_bd_pins hier_dac_play/enable]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins RAM_interconnect/ARESETN] [get_bd_pins RAM_interconnect/M00_ARESETN] [get_bd_pins RAM_interconnect/M01_ARESETN] [get_bd_pins RAM_interconnect/M05_ARESETN] [get_bd_pins RAM_interconnect/M06_ARESETN] [get_bd_pins RAM_interconnect/M07_ARESETN] [get_bd_pins RAM_interconnect/S00_ARESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins clocktreeMTS/egress_aresetn] [get_bd_pins hier_adc0_cap/s_axi_aresetn] [get_bd_pins hier_adc1_cap/s_axi_aresetn] [get_bd_pins hier_adc2_cap/s_axi_aresetn] [get_bd_pins hier_dac_cap/s_axi_aresetn] [get_bd_pins hier_dac_play/s_axi_aresetn]
  connect_bd_net -net s_axi_clk_1 [get_bd_pins RAM_interconnect/ACLK] [get_bd_pins RAM_interconnect/M00_ACLK] [get_bd_pins RAM_interconnect/M01_ACLK] [get_bd_pins RAM_interconnect/M05_ACLK] [get_bd_pins RAM_interconnect/M06_ACLK] [get_bd_pins RAM_interconnect/M07_ACLK] [get_bd_pins RAM_interconnect/S00_ACLK] [get_bd_pins clocktreeMTS/clkRFdiv2] [get_bd_pins gpio_control/dest_clk] [get_bd_pins hier_adc0_cap/s_axi_clk] [get_bd_pins hier_adc1_cap/s_axi_clk] [get_bd_pins hier_adc2_cap/s_axi_clk] [get_bd_pins hier_dac_cap/s_axi_clk] [get_bd_pins hier_dac_play/axis_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net trig_cap_1 [get_bd_pins gpio_control/dest_out] [get_bd_pins hier_adc0_cap/trig_cap] [get_bd_pins hier_adc1_cap/trig_cap] [get_bd_pins hier_adc2_cap/trig_cap] [get_bd_pins hier_dac_cap/trig_cap]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins RAM_interconnect/M02_ACLK] [get_bd_pins RAM_interconnect/M03_ACLK] [get_bd_pins RAM_interconnect/M04_ACLK] [get_bd_pins clocktreeMTS/s_axi_aclk] [get_bd_pins control_interconnect/ACLK] [get_bd_pins control_interconnect/M00_ACLK] [get_bd_pins control_interconnect/M01_ACLK] [get_bd_pins control_interconnect/S00_ACLK] [get_bd_pins gpio_control/s_axi_aclk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_dac_play/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0008000 -range 0x00008000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_dac_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0040000 -range 0x00008000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_adc0_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0048000 -range 0x00008000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_adc1_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0050000 -range 0x00008000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_adc2_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs gpio_control/axi_gpio_bram_adc/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs gpio_control/axi_gpio_dac/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs gpio_control/axi_gpio_fifoflush/S_AXI/Reg] -force
